...
// Ahora puedes usar servletContext para obtener la ruta real y realizar otras operaciones
...
<div class="container p-1">   
    ...
    <form method="post" action="SvPerros" enctype="multipart/form-data">
     ...
     <div class="mb-2">
        ...
        <button type="submit">Subir</button</fieldset>
     </div>
        ...
        <div class="col-md-8 " >
            <table class="table table-striped table-dark ">
                ...
                <tbody>
                        ...
                        if(!inPerros.isEmpty()){
                       for (Perros p : inPerros){
                        %>
                      <tr>
                        <td><%= p.getNombre() != null ? p.getNombre() : "" %></td>
                        <td><%= p.getRaza()!= null ? p.getRaza() : "" %></td>
                        <td><%= p.getFoto()!= null ? p.getFoto() : ""%></td>
                        <td><%= p.getPuntos()%></td>
                        <td><%= p.getEdad()%></td>
                        <td>                         
                        <!-- basurero -->
                     ...
                     // en caso de no cargar el video se muestra el mensaje no hay videos disponibles
                    out.print("No hay datos disponibles.");
